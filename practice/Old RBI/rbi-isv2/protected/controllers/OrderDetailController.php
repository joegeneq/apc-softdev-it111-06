...
class OrderDetailController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['OrderDetail']))
		{
			...
			$old->log_action="Created new order detail under Order # " . $model->order->id . " for customer, " . 
				$model->order->customer->cus_firstname . " " . $model->order->customer->cus_lastname . ".";
			$old->log_module="Order Detail";
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['OrderDetail']))
		{
			...
			$old = new Logs;
			$old->log_date_time=date('Y-m-d H:i:s');
			$old->log_action="Updated order detail under Order # " . $model->order->id . " for customer, " . 
				$model->order->customer->cus_firstname . " " . $model->order->customer->cus_lastname . ".";
			$old->log_module="Order Detail";
			$old->user_id= Yii::app()->user->id;
	...
	public function actionDelete($id)
	{
		...
		$old = new Logs;
			$old->log_date_time=date('Y-m-d H:i:s');
			$old->log_action="Deleted order detail under Order # " . $model->order->id . " for customer, " . 
				$model->order->customer->cus_firstname . " " . $model->order->customer->cus_lastname . ".";
			$old->log_module="Order Detail";
			$old->user_id= Yii::app()->user->id;
