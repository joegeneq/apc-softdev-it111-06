...
class SupplierController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Supplier']))
		{
			...
			$old->log_action="Created new supplier: " . $model->supplier_name . ".";
			$old->log_module="Supplier";
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Supplier']))
		{
			...
			$old = new Logs;
			$old->log_date_time=date('Y-m-d H:i:s');
			$old->log_action="Updated supplier, " . $model->supplier_name .  ".";
			$old->log_module="Supplier";
			$old->user_id= Yii::app()->user->id;
	...
	public function actionDelete($id)
	{
		...
		$old = new Logs;
			$old->log_date_time=date('Y-m-d H:i:s');
			$old->log_action="Deleted supplier, " . $model->supplier_name . ".";
			$old->log_module="Supplier";
			$old->user_id= Yii::app()->user->id;
